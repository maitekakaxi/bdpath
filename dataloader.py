...
from path_time_diffusion import PathTimeDataset,PathTimeTokenizer
# def get_dataloaders(config, tokenizer: PathTimeTokenizer):
#     trajs_csv = "/root/workspace/MTNet/data/demo/trajs_demo.csv"
#     times_csv = "/root/workspace/MTNet/data/demo/tstamps_demo.csv"
    
#     dataset = PathTimeDataset(trajs_csv, times_csv, tokenizer,
...
def get_dataloaders(config, tokenizer: PathTimeTokenizer):
    trajs_csv = "/root/workspace/MTNet/data/demo/trajs_demo.csv"
    times_csv = "/root/workspace/MTNet/data/demo/tstamps_demo.csv"
    dataset = PathTimeDataset(
        trajs_csv, times_csv, tokenizer,
        block_size=config.block_size
    )

    time_mean, time_std = dataset.get_time_stats()
    with open_dict(config.model):
        config.model.time_mean = float(time_mean)
        config.model.time_std = float(time_std)
