...
#         self.config = config
#         self.train_nlls = DummyNLLWrapper()
#         self.valid_nlls = DummyNLLWrapper()
#         self.gen_ppl = DummyNLL()
#         self.gen_entropy = DummyNLL()
...
#     def record_generative_perplexity(self, *args, **kwargs):
#         pass
...
class DummyNLLWrapper:
    ...
    def compute(self):
        return {
            ...
            'bpd': self.bpd.compute(),
            'ppl': self.ppl.compute()
        }
...
class DummyMetrics:
    ...
    def record_generative_perplexity(self, *args, **kwargs): pass
